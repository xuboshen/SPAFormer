...
def has_checkpoint(path_to_job):
    ...
    return any("checkpt" in f for f in files)
...
def load_test_checkpoint(cfg, model):
    ...
    if cfg.TEST.CHECKPOINT_FILE_PATH != "":
        ...
        load_checkpoint(last_checkpoint, model, cfg.NUM_GPUS > 1, change_model_keys=cfg.MViT._change_model_keys)
